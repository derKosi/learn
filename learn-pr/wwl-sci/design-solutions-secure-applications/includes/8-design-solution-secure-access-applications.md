...
- **Geo-filtering.** Block or allow traffic from specific countries or regions. This reduces attack surface for applications that only serve specific geographic markets.
...
### Complement, don't replace, application-level security
